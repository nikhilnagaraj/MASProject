...
import static core.model.time.RealtimeClockController.RtClockEventType.SWITCH_TO_REAL_TIME;
import static core.model.time.RealtimeClockController.RtClockEventType.SWITCH_TO_SIM_TIME;
import static core.model.time.RealtimeModel.SimpleState.*;
...
class RealtimeModel extends TimeModel implements RealtimeClockController {
    ...
    RealtimeModel(RealtimeBuilder builder) {
        ...
        stateMachine.getEventAPI().addListener(new Listener() {
            ...
            public void handleEvent(Event e) {
                @SuppressWarnings("unchecked") final StateTransitionEvent<Trigger, RealtimeModel> event =
    ...
    interface ClockState
        ...
        /**
         * @return The {@link ClockMode} the clock is in.
         */
