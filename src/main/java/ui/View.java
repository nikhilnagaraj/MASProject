...
import core.model.CompositeModelBuilder;
...
import core.model.UserInterface;
import core.model.time.Clock;
...
public final class View
    ...
    public abstract static class Builder extends AbstractModelBuilder<View, Void>
        ...
        static Builder create() {
            ...
            @Nullable final Locale loc = InputContext.getInstance().getLocale();
            if (loc != null
